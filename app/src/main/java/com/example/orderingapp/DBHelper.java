...
public class DBHelper extends SQLiteOpenHelper
{
    ...
    private static final String TABLE_CART = "cart", COLUMN_CART_ID = "id", COLUMN_CART_ACCOUNT_ID = "account_id", COLUMN_CART_PRODUCT_ID = "product_id", COLUMN_CART_NAME = "name", COLUMN_CART_PRICE = "price", COLUMN_CART_IMG_RID = "imgRID";
